...
fn migration_registers_all_native_indexes() {
    ...
    // INDEXED fields (27, including Entity.id, Note.id, AuditEvent.id for consolidation
    // resolution and audit dedup, and Skill.id for the by-domain-id procedural lookups).
    assert_eq!(
